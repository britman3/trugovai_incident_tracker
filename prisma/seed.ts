  ...
  const incidents = [
    {
      ...
      affectedDepartments: ['Marketing'] as const[],
      dataTypesInvolved: ['CustomerData'] as const[],
    ...
    },
    {
      ...
      affectedTool: 'Jasper',
      affectedDepartments: ['Marketing'] as const[],
      dataTypesInvolved: ['CustomerData', 'InternalCode'] as const[],
      reportedBy: 'IT Audit',
    ...
    },
    {
      ...
      affectedTool: 'Claude',
      affectedDepartments: ['Operations'] as const[],
      dataTypesInvolved: ['PublicData'] as const[],
    ...
    },
    {
      ...
      affectedDepartments: ['IT'] as const[],
      dataTypesInvolved: ['InternalCode'] as const[],
